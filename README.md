...
- [Nebula enclosure purchase list](ender5-mercury-one/nebula_enclosure_purchase_list.md) — full hardware, extrusion and panel BOM parsed from ZeroG's Nebula docs, with vendor links
